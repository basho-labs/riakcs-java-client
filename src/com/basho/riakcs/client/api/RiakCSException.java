...
/**
 * All exceptions are converted to {@Link RuntimeException} to reduce checked exceptions
 */
public class RiakCSException extends RuntimeException {
	...
	/**
	 * Wrap a checked {@link Exception} into a {@Link RuntimeException} keeping the stack trace in tact
	 * 
	 * @param e
	...
	/**
	 * Create a new {@Link RuntimeException} with the passed string error message
	 * 
	 * @param errorMessage
